package com.hrabl.code.generator.common.config;

import com.hrabl.code.generator.common.constants.TypeConstants;
import com.hrabl.code.generator.common.vo.BaseClassConfigVo;
import com.hrabl.code.generator.common.vo.UsualFrameConfigVo;
import lombok.Data;
...
public class PropertiesConfig implements Serializable {
    ...
    private String author = "baohua.yin";
    /**
     * service层基类配置信息
     */
